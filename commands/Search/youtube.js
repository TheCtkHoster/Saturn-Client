...
exports.run = async (client, message, args) => {
    ...
    .setDescription(`Unknown channel name. Pls try again..`)
      if (!name) return message.channel.send(well);
      ...
      .catch(() => message.channel.send("Unknown channel error. Pls try again.."));
