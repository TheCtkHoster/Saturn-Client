...
// <:online:742557148730359819> <:offline:742557131026464768> <:idle:742557093432655905> <:dnd:742557115876638762>
    ...
    let nickname = member.nickname !== undefined && member.nickname !== null ? member.nickname : "The User Is Not Changing his Nickname"; // Nickname
    ...
    .addField("Account created when", `${createdate} \n> ${created} day(s) ago`, true)
    .addField("Joined this server when", `${joindate} \n> ${joined} day(s) ago`, true)
